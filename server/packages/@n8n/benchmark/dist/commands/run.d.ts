...
export default class RunCommand extends Command {
    ...
    static flags: {
        ...
        collectAppMetrics: import("@oclif/core/lib/interfaces").BooleanFlag<boolean>;
        appMetricsPollInterval: import("@oclif/core/lib/interfaces").OptionFlag<number, import("@oclif/core/lib/interfaces").CustomOptions>;
    };
    run(): Promise<void>;
    private parseTags;
}
