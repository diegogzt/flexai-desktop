...
ruleTester.run('no-import-enterprise-edition', NoImportEnterpriseEditionRule, {
    valid: [
        ...
        {
            code: 'import { EnterpriseService } from "../environments.ee/services/enterprise-service"',
            filename: '/Users/test/project/packages/cli/test/integration/services/enterprise.integration.test.ts',
        },
    ],
    invalid: [
        {
...
//# sourceMappingURL=no-import-enterprise-edition.test.js.map