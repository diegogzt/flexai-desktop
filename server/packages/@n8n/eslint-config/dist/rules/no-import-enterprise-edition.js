...
export const NoImportEnterpriseEditionRule = ESLintUtils.RuleCreator.withoutDocs({
    meta: {
        type: 'problem',
        docs: {
            description: 'Disallow imports from .ee directories in non-enterprise code. Only code in .ee directories can import from other .ee directories.',
        },
        messages: {
            noImportEnterpriseEdition: 'Non-enterprise code cannot import from .ee directories. Only code in .ee directories can import from other .ee directories.',
        },
        schema: [],
    },
    defaultOptions: [],
...
//# sourceMappingURL=no-import-enterprise-edition.js.map