...
let AiController = class AiController {
    ...
    async validateConfig(_req, _res, payload) {
        return await this.workflowBuilderService.validateConfig(payload.provider, payload.apiKey);
    }
};
...
__decorate([
    (0, decorators_1.Post)('/validate-config'),
    __param(2, decorators_1.Body),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, Object, api_types_1.AiValidateConfigRequestDto]),
    __metadata("design:returntype", Promise)
], AiController.prototype, "validateConfig", null);
