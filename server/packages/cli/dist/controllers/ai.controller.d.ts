import { AiChatRequestDto, AiApplySuggestionRequestDto, AiAskRequestDto, AiFreeCreditsRequestDto, AiBuilderChatRequestDto, AiSessionRetrievalRequestDto, AiSessionMetadataResponseDto, AiValidateConfigRequestDto } from '@n8n/api-types';
...
export declare class AiController {
    ...
    validateConfig(_req: AuthenticatedRequest, _res: Response, payload: AiValidateConfigRequestDto): Promise<{
        success: boolean;
        message?: undefined;
    } | {
        success: boolean;
