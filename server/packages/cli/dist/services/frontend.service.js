...
let FrontendService = class FrontendService {
    ...
    getPublicSettings() {
        const { userManagement: { authenticationMethod, showSetupOnFirstLoad, smtpSetup }, sso: { saml: ssoSaml, ldap: ssoLdap, oidc: ssoOidc }, authCookie, previewMode, enterprise: { saml, ldap, oidc }, } = this.getSettings();
