...
let WorkflowExecutionService = class WorkflowExecutionService {
    ...
    async executeManually(payload, user, pushRef) {
        ...
        if (isFullExecutionFromUnknownTrigger(payload)) {
            const pinnedTrigger = this.selectPinnedTrigger(payload.workflowData, payload.destinationNode, payload.workflowData.pinData ?? {});
    ...
    partialExecutionFulfilsPreconditions(payload) {
        ...
        return (0, n8n_core_1.anyReachableRootHasRunData)(n8n_core_1.DirectedGraph.fromNodesAndConnections(payload.workflowData.nodes, payload.workflowData.connections), payload.destinationNode, payload.runData);
    }
};
